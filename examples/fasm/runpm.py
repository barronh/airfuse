...
logging.info(f'fasmcfgpath={fasmcfgpath}')
...
andf = airnowfasm(spc, nowcast=nowcast).pair(date, modvar, mod.proj)
...
padf = purpleairfasm(spc, nowcast=nowcast).pair(date, modvar, mod.proj)
